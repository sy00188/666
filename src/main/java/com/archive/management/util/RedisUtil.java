...
public class RedisUtil {
    ...
    public void del(String... key) {
        try {
            ...
            log.error("删除缓存失败: keys={}", (Object) key, e);
        }
    }
    ...
    public Map<Object, Object> hmget(String key) {
        try {
            ...
            log.error("Hash批量获取失败: key={}", key, e);
            return null;
        }
    }
    ...
    public boolean hmset(String key, Map<String, Object> map, long time) {
        try {
            ...
            log.error("Hash批量设置失败: key={}, time={}", key, time, e);
            return false;
        }
    }
    ...
    public boolean hset(String key, String item, Object value, long time) {
        try {
            ...
            log.error("Hash设置失败: key={}, item={}, time={}", key, item, time, e);
            return false;
        }
    }
    ...
    public boolean hHasKey(String key, String item) {
        try {
            ...
            log.error("Hash判断key存在失败: key={}, item={}", key, item, e);
            return false;
        }
    }
    ...
    public boolean sHasKey(String key, Object value) {
        try {
            ...
            log.error("Set判断成员存在失败: key={}", key, e);
            return false;
        }
    }
    ...
    public long sSetAndTime(String key, long time, Object... values) {
        try {
            ...
            log.error("Set添加失败: key={}, time={}", key, time, e);
            return 0;
        }
    }
    ...
    public List<Object> lGet(String key, long start, long end) {
        try {
            ...
            log.error("List获取失败: key={}, start={}, end={}", key, start, end, e);
            return null;
        }
    }
    ...
    public long lGetListSize(String key) {
        try {
            ...
            log.error("List获取大小失败: key={}", key, e);
            return 0;
        }
    }
    ...
    public Object lGetIndex(String key, long index) {
        try {
            ...
            log.error("List获取索引值失败: key={}, index={}", key, index, e);
            return null;
        }
    }
    ...
    public boolean lSet(String key, Object value, long time) {
        try {
            ...
            log.error("List添加失败: key={}, time={}", key, time, e);
            return false;
        }
    }
    ...
    public boolean lSet(String key, List<Object> value, long time) {
        try {
            ...
            log.error("List批量添加失败: key={}, time={}", key, time, e);
            return false;
        }
    }
    ...
    public long lRemove(String key, long count, Object value) {
        try {
            ...
            log.error("List移除失败: key={}, count={}", key, count, e);
            return 0;
        }
    }
